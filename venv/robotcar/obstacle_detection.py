...
class ObstacleDetector:
    ...
    def is_collision(self):
        try:
            ...
            # Perform collision detection logic based on obstacle data
            # Example: Check if there are obstacles within a certain distance threshold
            collision_threshold = 10  # Adjust as needed
            for obstacle in obstacle_data:
                obstacle_distance = math.sqrt(obstacle[0]**2 + obstacle[1]**2)
                if obstacle_distance < collision_threshold:
