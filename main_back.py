...
async def explore(q_agent, mecanum_wheels, localization, is_exploration_complete):
    ...
    while not is_exploration_complete:
        ...
        # Inside the explore function in main.py
        state = localization.get_current_position()
        action = q_agent.get_action(state)

        # Print the values before calling update_odometry
 #       print("Wheel speeds:", wheel_speeds)  # Check if this is correct
 #       print("Time delta:", dt)  # Check if this is correct

 #       localization.update_odometry(wheel_speeds, dt)
